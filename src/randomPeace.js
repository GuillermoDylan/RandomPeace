...
function setup() {
    ...
    // Create buttons
    // Create buttons
    button1 = createButton('Usuario - IA');
    applyStyles(button1);
    positionButton(button1, centerX - buttonWidth / 2, centerY - buttonHeight - buttonSpacing);
    button1.mousePressed(button1Clicked);

    button2 = createButton('Multiusuario');
    applyStyles(button2);
    positionButton(button2, centerX - buttonWidth / 2, centerY);
    button2.mousePressed(button2Clicked);

    button3 = createButton('Automata Celular');
    applyStyles(button3);
